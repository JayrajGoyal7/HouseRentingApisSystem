...
import com.project.house.payloads.PostDto;
import com.project.house.payloads.PostResponse;
import com.project.house.repositories.CategoryRepo;
import com.project.house.repositories.PostRepo;
import com.project.house.repositories.UserRepo;
import com.project.house.services.PostService;
...
public class PostServiceImpl implements PostService {
	...
	public PostResponse getAllPost(Integer pageNumber, Integer pageSize, String sortBy, String sortDir) {
		...
		Sort sort = sortDir.equalsIgnoreCase("ASC")?sort = Sort.by(sortDir).ascending():Sort.by(sortDir).descending();
